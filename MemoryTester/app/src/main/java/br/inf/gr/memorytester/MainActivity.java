...
public class MainActivity extends AppCompatActivity implements AdManager.AdListener{
    ...
    private final int[][] shapeLevels = {
            {R.drawable.car_shape, R.drawable.boat_shape, R.drawable.baloon_shape},
            {R.drawable.car_shape, R.drawable.boat_shape, R.drawable.baloon_shape},
            {R.drawable.car_shape, R.drawable.boat_shape, R.drawable.baloon_shape},
            {R.drawable.car_shape, R.drawable.boat_shape, R.drawable.baloon_shape, R.drawable.helicopter_shape},
            {R.drawable.car_shape, R.drawable.boat_shape, R.drawable.baloon_shape, R.drawable.helicopter_shape, R.drawable.train_shape}
    };
